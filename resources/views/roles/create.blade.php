...
<head>
    ...
    <title>Nuevo rol - DreamHorses</title>
    <script>
    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content bg-base-100 text-base-content">
            ...
            <div class="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold">Crear nuevo rol</h1>
                    <p class="text-base-content/70">Define el nombre del rol y selecciona sus permisos.</p>
                </div>
